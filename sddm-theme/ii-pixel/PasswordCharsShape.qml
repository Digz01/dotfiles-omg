...
Canvas {
    ...
    onPaint: {
        ...
        switch (root.shapeIndex % 7) {
            case 0: poly = MaterialShapes.getCircle(); break
            case 1: poly = MaterialShapes.getCircle(); break
            case 2: poly = MaterialShapes.getCircle(); break
            case 3: poly = MaterialShapes.getCircle(); break
            case 4: poly = MaterialShapes.getCircle(); break
            case 5: poly = MaterialShapes.getCircle(); break
            default: poly = MaterialShapes.getCircle(); break
        }
        if (!poly) return
